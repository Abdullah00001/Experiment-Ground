...
exports.Countries = exports.MAX_IMPORT_FILE_SIZE = exports.allowedMimeTypes = exports.AccountActivityMap = exports.supportEmail = exports.profileUrl = exports.dashboardUrl = exports.getLocationFromIP = exports.clearDevicePageTokenExpireIn = exports.baseUrl = exports.emailRegex = exports.saltRound = exports.otpExpireAt = exports.maxOtpResendPerHour = exports.resendOtpEmailCoolDownWindow = exports.otpRateLimitSlidingWindow = exports.otpRateLimitMaxCount = exports.serverCacheExpiredIn = exports.changePasswordPageTokenExpiresIn = exports.activationTokenExpiresIn = exports.recoverSessionExpiresIn = exports.refreshTokenExpiresInWithoutRememberMe = exports.addPasswordPageTokenExpiresIn = exports.refreshTokenExpiresIn = exports.accessTokenExpiresIn = exports.corsWhiteList = void 0;
...
exports.accessTokenExpiresIn = '15m';
exports.refreshTokenExpiresIn = '7d';
exports.addPasswordPageTokenExpiresIn = '7d';
exports.refreshTokenExpiresInWithoutRememberMe = '1d';
exports.recoverSessionExpiresIn = '5m';
exports.activationTokenExpiresIn = '1d';
exports.changePasswordPageTokenExpiresIn = '15m';
exports.serverCacheExpiredIn = '5m';
exports.otpRateLimitMaxCount = 15;
exports.otpRateLimitSlidingWindow = '1m';
exports.resendOtpEmailCoolDownWindow = '2m';
exports.maxOtpResendPerHour = 5;
exports.otpExpireAt = 4;
exports.saltRound = 10;
exports.emailRegex = /^[\w.-]+@[a-zA-Z\d.-]+\.[a-zA-Z]{2,}$/;
exports.baseUrl = {
    v1: '/api/v1',
};
exports.clearDevicePageTokenExpireIn = '60m';
...
exports.dashboardUrl = 'https://contacts.workly.ink/';
exports.profileUrl = 'https://contacts.workly.ink/accountscenter';
exports.supportEmail = 'worklycontacts@gmail.com';
exports.AccountActivityMap = {
    [user_enums_1.ActivityType.LOGIN_SUCCESS]: {
        title: 'Logged in Successfully',
        description: 'Your account was accessed using the correct credentials. If you did not perform this login, please review your account activity and change your password immediately.',
    },
    [user_enums_1.ActivityType.LOGIN_FAILED]: {
        title: 'Failed Login Attempt',
        description: 'Someone attempted to log in to your account with incorrect credentials. If this was not you, we recommend updating your password and enabling extra security measures.',
    },
    [user_enums_1.ActivityType.SIGNUP_SUCCESS]: {
        title: 'Account Was Created',
        description: 'Your Workly Contacts account was successfully registered.',
    },
    [user_enums_1.ActivityType.PASSWORD_RESET]: {
        title: 'Password Was Changed',
        description: 'Your account password was changed successfully. If you did not perform this action, please secure your account by resetting your password and reviewing recent activity.',
    },
    [user_enums_1.ActivityType.ACCOUNT_LOCKED]: {
        title: 'Account Locked',
        description: 'Your account has been temporarily locked due to multiple unsuccessful login attempts. Please verify your identity or contact support to regain access.',
    },
    [user_enums_1.ActivityType.ACCOUNT_ACTIVE]: {
        title: 'Account Activated',
        description: 'Your account has been successfully activated and is now ready for use. If you did not initiate this action, please contact support immediately.',
    },
    [user_enums_1.ActivityType.ACCOUNT_DELETE_SCHEDULE]: {
        title: 'Account Deletion Scheduled',
        description: 'You requested to delete your account. Your account and all associated data are scheduled for permanent deletion after 7 days. If you log in before that time, the deletion will be automatically cancelled.',
    },
    [user_enums_1.ActivityType.ACCOUNT_DELETE_SCHEDULE_CANCEL]: {
        title: 'Account Deletion Cancelled',
        description: 'Your recent login activity has cancelled the previously scheduled account deletion. Your account is now active again. If you did not perform this login, please secure your account immediately.',
    },
};
...
exports.MAX_IMPORT_FILE_SIZE = 2 * 1024 * 1024;
exports.Countries = [
