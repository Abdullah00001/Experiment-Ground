...
const accountDeletionScheduleCancelAndLoginEmailTemplate = `
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
            ...
            <tr>
              <td style="padding: 40px 30px">
                ...
                <div style="font-size: 16px; color: #475569; line-height: 1.7">
                  Welcome back! Your Workly Contacts account ({{email}}) login
                  was successful.We have canceled the scheduled deletion of your
                  account that was originally set for
                  <strong>{{deleteAt}}</strong>. Your account remains active and
                  fully accessible.
                </div>
...
`;
exports.default = accountDeletionScheduleCancelAndLoginEmailTemplate;
