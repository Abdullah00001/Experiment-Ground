...
const user_controllers_1 = __importDefault(require("../../modules/user/user.controllers"));
...
const { isSignupUserExist, checkOtp, isUserExistAndVerified, checkPassword, isUserExist, isUserVerified, checkAccessToken, checkRefreshToken, checkRecoverOtp, checkR_stp1Token, checkR_stp2Token, checkR_stp3Token, otpRateLimiter, resendOtpEmailCoolDown, checkActivationToken, checkIpBlackList, checkLoginAttempts, checkActiveToken, checkChangePasswordPageToken, checkSession, checkSessionsLimit, checkClearDevicePageToken, } = user_middlewares_1.default;
const { handleSignUp, handleVerifyUser, handleLogin, handleAccountActivation, handleCheck, handleRefreshTokens, handleLogout, handleResend, handleCheckResendStatus, handleCheckClearDevicePageToken, handleFindUser, handleSentRecoverOtp, handleVerifyRecoverOtp, handleResendRecoverOtp, handleResetPassword, handleCheckR_Stp1, handleCheckR_Stp2, handleCheckR_Stp3, handleProcessOAuthCallback, handleCheckChangePasswordPageToken, handleChangePasswordAndAccountActivation, handleCheckActivationTokenValidity, handleRetrieveSessionsForClearDevice, handleClearDeviceAndLogin, handleRecoverUserInfo, handleSecurityOverview, handleActiveSession, handleRecentActivity, handleSessionRemove, handleForceLogout, handleRetrieveActivity, handleRetrieveActivityDetails, handleCreatePassword, } = user_controllers_1.default;
...
router
    .route('/auth/login')
    .post(checkIpBlackList, checkLoginAttempts, isUserExistAndVerified, checkPassword, checkSessionsLimit, handleLogin);
...
router.route('/google/callback').get(passport_1.default.authenticate('google', {
    ...
    session: false,
}), checkSessionsLimit, handleProcessOAuthCallback);
router
...
router
    ...
    .post(checkR_stp2Token, otpRateLimiter, checkRecoverOtp, handleVerifyRecoverOtp);
router
